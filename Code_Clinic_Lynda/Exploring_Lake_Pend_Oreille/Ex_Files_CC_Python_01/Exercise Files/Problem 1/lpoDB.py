...
class lpoDB():
    ...
    def get_data_for_range(self, start, end):
        ...
        # determine pre-2007 dates to update and append to items
        ...
        # determine post-2006 dates to update and append to items
        ...
        # generate a items of dates between temp_start and end
        ...
        for entry in statuses:
            if entry['Status'] == 'COMPLETE':
                ...
                try: # update for any new data first, then remove from dates_to_update items
